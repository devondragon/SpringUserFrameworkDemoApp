...
/**
 * Mock OAuth2 Server for testing different OAuth2 scenarios.
 * Provides methods to simulate various OAuth2 flows and error conditions.
 */
public class MockOAuth2Server {
    ...
    public void simulateAuthorizationDenied() {
        ...
        stubFor(get(urlPathMatching(authPath + ".*"))
            .willReturn(aResponse()
                .withStatus(302)
                .withHeader("Location", "http://localhost:8080/login/oauth2/code/" + provider + 
    ...
    public void simulateInvalidToken() {
        ...
        stubFor(get(urlEqualTo(userInfoPath))
            .willReturn(aResponse()
                .withStatus(401)
                .withHeader("Content-Type", "application/json")
                .withBody("{" +
    ...
    public void simulateNetworkTimeout() {
        ...
        stubFor(post(urlEqualTo(tokenPath))
            .willReturn(aResponse()
                .withFixedDelay(30000) // 30 second delay to trigger timeout
                .withStatus(504)));
    }
        ...
        stubFor(get(urlPathMatching("/me.*"))
            .willReturn(aResponse()
                ...
                .withBody("{" +
                    ...
                    "\"last_name\": \"" + (name.split(" ").length > 1 ? name.split(" ")[1] : "User") + "\"," +
                    "\"email\": \"" + email + "\"" +
                    "}")));
    }
