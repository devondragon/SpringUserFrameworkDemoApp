...
import static com.digitalsanctuary.spring.demo.user.ui.data.UiTestData.TEST_USER_ENCODED_PASSWORD;
...
public class Jdbc {
    ...
    public static void saveTestUser(UserDto userDto) {
        try (Connection connection = ConnectionManager.open()) {
            ...
            Object[] params =
                    new Object[] {id, userDto.getFirstName(), userDto.getLastName(), userDto.getEmail(), TEST_USER_ENCODED_PASSWORD, true, 0, false};
