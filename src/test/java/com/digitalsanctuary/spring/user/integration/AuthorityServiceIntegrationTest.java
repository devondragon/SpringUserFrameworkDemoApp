...
class AuthorityServiceIntegrationTest {
        ...
        void getAuthoritiesFromUser_adminUser_hasAllAdminPrivileges() {
                // Given
                User adminUser = UserTestDataBuilder.anAdminUser().withEmail("admin@example.com").withId(null).build();
        ...
        void getAuthoritiesFromUser_cascadingOperations_maintainsIntegrity() {
                ...
                User user = UserTestDataBuilder.aVerifiedUser().withEmail("cascade@example.com").withId(null).build();
        ...
        void getAuthoritiesFromUser_transactionalConsistency_maintainsIntegrity() {
                ...
                assertThat(updatedAuthorities).extracting(GrantedAuthority::getAuthority).contains("TEMP_PRIVILEGE");
        }
}
