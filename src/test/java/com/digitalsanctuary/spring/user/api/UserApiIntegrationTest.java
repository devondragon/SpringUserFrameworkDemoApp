 ...
 * 
 * This test class verifies the complete API behavior including:
...
class UserApiIntegrationTest {
    ...
    class ResendTokenTests {
        ...
        void shouldResendTokenForUnverifiedUser() throws Exception {
            ...
            // When
            ResultActions result = mockMvc.perform(post(API_BASE_PATH + "/resendRegistrationToken")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(requestBody)
                    .with(csrf()));
    ...
    class AuthenticatedUserTests {
        ...
        void shouldUpdatePasswordWithCorrectOldPassword() throws Exception {
            ...
            // When
            ResultActions result = mockMvc.perform(post(API_BASE_PATH + "/updatePassword")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(requestBody)
                    .with(csrf()));
