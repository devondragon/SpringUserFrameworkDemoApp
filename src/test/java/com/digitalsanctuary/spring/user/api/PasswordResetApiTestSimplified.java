...
/**
 * Simplified password reset API tests focusing on API behavior
...
class PasswordResetApiTestSimplified {
    ...
    void shouldNotRevealUserExistence() throws Exception {
        ...
        MvcResult validResult = mockMvc.perform(post(RESET_PASSWORD_URL)
                .contentType(MediaType.APPLICATION_JSON)
        ...
        MvcResult invalidResult = mockMvc.perform(post(RESET_PASSWORD_URL)
                .contentType(MediaType.APPLICATION_JSON)
