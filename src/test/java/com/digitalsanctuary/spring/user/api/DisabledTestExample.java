...
public class DisabledTestExample {
    ...
    @Disabled("FRAMEWORK-ISSUE: Spring Security returns empty 401 response instead of JSON with error message. "
            + "Expected: {\"success\":false,\"message\":\"User Not Logged In!\"} " + "Actual: Empty response with 401 status. "
    ...
    @Test
    @Disabled("TEST-INFRA: Requires OAuth2 mock server setup. " + "Test validates OAuth2 flow but no mock authorization server configured. "
